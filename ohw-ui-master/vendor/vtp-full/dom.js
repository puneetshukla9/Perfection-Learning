    ...
    normalize: function() {
        ...
        while (child) {
            ...
            if (next && next.nodeType == TEXT_NODE && child.nodeType == TEXT_NODE) {
                ...
                child.appendData(next.nodeValue);
            } else {
                child.normalize();
                child = next;
            }
...
function serializeToString(node, buf) {
    switch (node.nodeType) {
      ...
      case TEXT_NODE:
        return buf.push(node.nodeValue.replace(/[<&]/g, _xmlEncoder));

      case CDATA_SECTION_NODE:
        return buf.push("<![CDATA[", node.nodeValue, "]]>");

      case COMMENT_NODE:
        return buf.push("<!--", node.nodeValue, "-->");
      ...
      case PROCESSING_INSTRUCTION_NODE:
        return buf.push("<?", node.target, " ", node.nodeValue, "?>");
